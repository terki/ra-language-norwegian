...
var norwegianMessages = {
    ra: {
        ...
        input: {
            file: {
                upload_several: 'Dra og slipp noen filer for å laste opp, eller klikk for å velge.',
                upload_single: 'Dra og slipp en fil som skal lastes opp, eller klikk for å velge.',
            },
            image: {
                upload_several: 'Dra og slipp noen bilder for å laste opp, eller klikk for å velge.',
                upload_single: 'Dra og slipp et bilde som skal lastes opp, eller klikk for å velge.',
            },
            references: {
                all_missing: 'Klarte ikke å finne referansedata',
                many_missing: 'Minst én av de tilknyttede referansene ser ikke lenger ut til å være tilgjengelige.',
                single_missing: 'Tilknyttet referanse ser ikke ut til å være tilgjengelig.',
            },
            password: {
        ...
        message: {
            ...
            details: 'Detaljer',
            error: "En klientfeil oppstod og din forespørsel kunne ikke ble fullført.",
            invalid_form: 'Skjemaet er ugyldig. Vennligst sjekk for feil.',
            loading: 'Siden laster, et lite øyeblikk bare',
            no: 'Nei',
            not_found: 'Du har skrevet feil URL eller fulgt en ugyldig lenke.',
            yes: 'Ja',
            unsaved_changes: "Noen av endringene ble ikke lagret. Er du sikker på at du vil se bort fra disse?",
        },
        navigation: {
            no_results: 'Ingen resultater funnet',
            no_more_results: 'Side %{page} er utenfor avmålt område. Prøv forrige side.',
        ...
        notification: {
            ...
            i18n_error: 'Kan ikke laste oversettelser for valgt språk',
...
exports.default = norwegianMessages;
